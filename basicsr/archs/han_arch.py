...
class HAN(nn.Module):
    def __init__(self, n_resgroups=10,n_resblocks=20,n_feats=64,reduction=16,scale=2,rgb_range=1.0,n_colors=1,res_scale=1, conv=default_conv):
