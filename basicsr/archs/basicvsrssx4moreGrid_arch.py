...
class BasicVSRSubSubX4moGrid(nn.Module):
    # 无光流模块的basicvsr++
    ...
    def __init__(self,
        ...
        modules = ['backward_1', 'forward_1','backward_2', 'forward_2','backward_3', 'forward_3']
...
if __name__=="__main__":
    ...
    print(encoder)
    """
    model=BasicVSRSubSubX4moGrid()
    inputs = torch.rand(1,7,1,40,40)
