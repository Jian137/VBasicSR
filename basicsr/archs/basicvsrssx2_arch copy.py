...
class BasicVSRSubSubX2(nn.Module):
    # 无光流模块的basicvsr++
    ...
    def __init__(self,
        ...
        super().__init__()
        self.mid_channels = mid_channels  # type: ignore
    ...
    def propagate(self, feats, module_name):
        ...
        # 添加记忆模块
        return feats
    def new_propagate(self,feat_current,feat_prop):
        mask1 = calculate_mask(feat_current)
